...
var (
	...
	actions = map[string]func(){
		...
		"ActionJumpCurrentDir":     limit(ModeNormal, func() { enterJumpMode(cjumpCurrentDir) }),
		"ActionJumpBookmarkOnce":   limit(ModeNormal, func() { enterJumpMode(jumpBookmark) }),
		"ActionJumpBookmark":       limit(ModeNormal, func() { enterJumpMode(cjumpBookmark) }),
		"ActionJumpAllOnce":        limit(ModeNormal, func() { enterJumpMode(jumpAll) }),
		"ActionJumpAll":            limit(ModeNormal, func() { enterJumpMode(cjumpAll) }),
